(function() {
  ...
  a.register("jobs.qrcode_login", function(h) {
    var k = {},
      c = h.common.channel.qrcode_login;
    var o = {
      entry: "sso",
      domain: "weibo.com",
    ...
    var l = function(p) {
      ...
      var r = d.qrcode_login + "?entry=" + encodeURIComponent(q.entry) + "&returntype=" + encodeURIComponent(q.returntype) + "&alt=" + encodeURIComponent(q.alt) + "&url=" + encodeURIComponent(s);
      c.fire("login_success", r)
    };
    var b = function(s, u) {
